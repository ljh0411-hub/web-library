  	...
  	<script type="text/javascript">
		$(function(){
			$("#next").click(function(){
				...
				page++;
				location.href = "/webLibrary/book?page="+page;
			})
			...
			$("#first").click(function () {
				location.href = "/webLibrary/book?page=1";
			})

			$("#last").click(function(){
				var pages = parseInt($("#pages").html());
				location.href = "/webLibrary/book?page="+pages;
			})
		})
	</script>
  </head>
  ...
  <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				当前位置:&nbsp;&nbsp;<a href="/webLibrary/book?method=findAll&page=1">首页</a>
				<div id="readerBlock">欢迎回来&nbsp;:<a href="/webLibrary/book?method=findAllBorrow&page=1">${sessionScope.reader.name }</a>&nbsp;<a href="login.jsp">注销</a></div>
		</div>
		<div class="img_block">
		...
		<table class="table" cellspacing="0">
			...
			<c:forEach items="${list}" var="book">
				<tr>
					...
					<td>
						<a href="/webLibrary/book?method=addBorrow&bookid=${book.id}">借阅</a>
					</td>
				</tr>
			</c:forEach>
