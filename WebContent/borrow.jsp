	  ...
	  <script type="text/javascript">
		  $(function(){
			  $("#next").click(function(){
				  ...
				  page++;
				  location.href = "/webLibrary/book?method=findAllBorrow&page="+page;
			  })
			  ...
			  $("#first").click(function () {
				  location.href = "/webLibrary/book?method=findAllBorrow&page=1";
			  })

			  $("#last").click(function(){
				  var pages = parseInt($("#pages").html());
				  location.href = "/webLibrary/book?method=findAllBorrow&page="+pages;
			  })
		  })
	  </script>
  </head>
    ...
    <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				当前位置:&nbsp;&nbsp;<a href="/webLibrary/book?page=1">首页</a>
				<div id="readerBlock">欢迎回来&nbsp;:${reader.name }&nbsp;<a href="/webLibrary/logout">注销</a></div>
		</div>
		<div class="img_block">
