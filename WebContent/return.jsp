	  ...
	  <script type="text/javascript">
		  $(function(){
			  $("#next").click(function(){
				  ...
				  page++;
				  location.href = "/webLibrary/admin?method=getBorrowed&page="+page;
			  })
			  ...
			  $("#first").click(function () {
				  location.href = "/webLibrary/admin?method=getBorrowed&page=1";
			  })

			  $("#last").click(function(){
				  var pages = parseInt($("#pages").html());
				  location.href = "/webLibrary/admin?method=getBorrowed&page="+pages;
			  })
		  })
	  </script>
  </head>
    ...
    <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				当前位置:&nbsp;&nbsp;<a href="/webLibrary/admin?page=1">借书管理</a>
				<div id="readerBlock">欢迎回来&nbsp;:${admin.username }&nbsp;<a href="login.jsp">注销</a></div>
		</div>
		<div class="img_block">
		...
		<table class="table" cellspacing="0">
			...
			<tr>
				...
				<td>
					<a href="/webLibrary/admin?method=handle&id=${borrow.id }&state=3">归还</a>
				</td>
			</tr>
			</c:forEach>
